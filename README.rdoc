...
But, it might just make more sense to copy down the rake task all by itself:

  wget http://github.com/mikldt/db_cull/blob/master/tasks/db_cull_tasks.rake > lib/tasks/db_cull_tasks.rake
